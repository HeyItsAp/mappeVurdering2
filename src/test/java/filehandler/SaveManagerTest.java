 ...
 *      Not well branched and developed as previous FilehandlerTest, as this uses the same methods.
 *      Only unique logic is making a folder.
 * Coordinator logic is tested with in-memory fakes (no filesystem).
 * Filesystem behavior is tested with @TempDir.
 */
public class SaveManagerTest {
    // ── Helpers ──────────────────────────────────────────────────────────────

    private Player dummyPlayer() {
        return new Player("TestPlayer", new BigDecimal("5000"), new BigDecimal("3000"),
