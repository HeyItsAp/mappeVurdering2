...
public class StrategyRegister {
    ...
    /**
     * String id, should be the same as when defining {@code #getStrategyId()} in {@link PriceStrategy}'s
     */
    private static final Map<String, Supplier<PriceStrategy>> Registry = new HashMap<>(Map.of(
