/**
 * Represents a portfolio of shares owned by an investor. The portfolio allows for adding and removing shares, as well as checking if a specific share is contained within the portfolio.
 * 
 * @author Adrian
 */
