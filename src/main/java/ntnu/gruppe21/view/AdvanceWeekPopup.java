...
public class AdvanceWeekPopup extends Popup {
  ...
  protected List<Node> buildContent() {
    ...
    Label currentLabel = new Label("Week 7");
    currentLabel.setStyle("-fx-font-size: 52px; -fx-font-weight: bold;");

    Label arrow = new Label("↓");
    arrow.setStyle("-fx-font-size: 24px; -fx-text-fill: #555;");

    Label nextLabel = new Label("Week 8");
    nextLabel.setStyle("-fx-font-size: 52px; -fx-font-weight: bold; -fx-text-fill: #3a3aaa;");

    Label desc1 = new Label("All 500 stocks get a new price.");
    ...
    return List.of(currentLabel, arrow, nextLabel, desc1, desc2, buttons);
  }
}
